...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("DriveTrain1", "Speed Controller 1", (Spark) driveTrainSpeedController1);
        
        driveTrainSpeedController2 = new Spark(1);
        LiveWindow.addActuator("DriveTrain2", "Speed Controller 2", (Spark) driveTrainSpeedController2);
        
        driveTrainSpeedController3 = new Spark(2);
        LiveWindow.addActuator("DriveTrain3", "Speed Controller 3", (Spark) driveTrainSpeedController3);
        
        driveTrainSpeedController4 = new Spark(3);
        LiveWindow.addActuator("DriveTrain4", "Speed Controller 4", (Spark) driveTrainSpeedController4);
