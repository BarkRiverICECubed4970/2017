...
public class ReleaseGear extends TimedCommand {
    ...
    public ReleaseGear(double dutyCycle) {
        this(0, dutyCycle);
    }

    public ReleaseGear(double timeout, double dutyCycle) {
        super(timeout);
    ...
    protected void execute() {
    	Robot.gearMotor.release(SmartDashboard.getNumber("Release Gear Duty Cycle", storedDutyCycle));
    }
