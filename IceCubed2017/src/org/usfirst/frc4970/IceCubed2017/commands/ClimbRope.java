...
public class ClimbRope extends Command {
	...
	private double climbDutyCycle;
	
    public ClimbRope(double dutyCycle) {
    ...
    protected void initialize() {
    	climbDutyCycle = SmartDashboard.getNumber("Climb Rope Duty Cycle", storedDutyCycle);
    }

    // Called repeatedly when this Command is scheduled to run
    protected void execute() {
    	Robot.climbMotor.climb(climbDutyCycle);
    }
