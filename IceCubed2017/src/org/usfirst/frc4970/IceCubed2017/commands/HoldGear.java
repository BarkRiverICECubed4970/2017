...
public class HoldGear extends Command {
	...
	private double holdGearDutyCycle;
	
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public HoldGear(double dutyCycle) {
    ...
    protected void initialize() {
    	holdGearDutyCycle = SmartDashboard.getNumber("Hold Gear Duty Cycle", storedDutyCycle);
    }

    // Called repeatedly when this Command is scheduled to run
    protected void execute() {    	    	
       	Robot.gearMotor.grab(holdGearDutyCycle);
    }
