...
public class OI {
    ...
    public OI() {
        ...
        joystickButton6.whileHeld(new ClimbRope());
        ...
        SmartDashboard.putData("PlaceGearCenterGamble", new PlaceGear(0.0, true));
        SmartDashboard.putData("PlaceGearCenterSafe", new PlaceGear(0.0, false));
        SmartDashboard.putData("PlaceGearLeft", new PlaceGear(60.0, false));
        SmartDashboard.putData("PlaceGearRight", new PlaceGear(-60.0, false));
