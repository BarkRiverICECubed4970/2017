...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("PlaceGearCenterGamble", new PlaceGearGamble());
        SmartDashboard.putData("PlaceGearCenterSafe", new PlaceGear(0.0));
        SmartDashboard.putData("PlaceGearLeft", new PlaceGear(60.0));
        SmartDashboard.putData("PlaceGearRight", new PlaceGear(-60.0));
