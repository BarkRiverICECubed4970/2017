...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("TimedTurn", new TimedTurn(Robot.timedTurnTimeout, Robot.timedTurnRate));
        ...
        SmartDashboard.putData("TurnDegrees", new TurnDegrees(Robot.turnDegrees));
